...
\begin{figure}[htbp]
    \centering
        \includegraphics[width=0.8\textwidth,page=1]{Figures/symulacjaSpeedgoatHil.pdf}
...
wykorzystanie go do emulacji pakietów czujnika pokładowego rakiety - VectorNav 200 \cite{vectornav200}.
...
\begin{enumerate}
    \item aa\todo[inline]{opisać krótko}
\end{enumerate}
