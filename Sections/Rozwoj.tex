...
ten, o ile skuteczny i jednorazowy dla jednego włożenia układu sterowania w urządzenie pomiarowe, 
...
Każdy z punktów zostanie osiągnięty w dwóch kierunkach - raz
ster się wychyli do położenia \SI{2}{\degree} większego, raz o \SI{2}{\degree} mniejszego. Wartość pomiaru zostanie więc uśredniona z dwóch kierunków.
Tym samym zostanie zmitygowany wpływ luzów w systemie na pomiar wychylenia steru.
% \todo[inline]{Wymyślić czy jest coś lepszego niż średnia z ruchu w jedną i drugą stronę}
Kalibrację należy wykonywać na systemie nieobciążonym, tj. pozbawionym sprężyn.
...
Obecnie używanym baudrate jest \SI{2000000}{\bit\per\second}, został on uznany za 
niezawodny eksperymentalnie. Przy tym baudrate odczytanie wychylenia sterów z \textit{CASKET}a
powinno zająć \SI{64}{\micro\second}. Natomiast wysłanie pakietu z wychyleniem sterów zajmuje \SI{168}{\micro\second}.
Działanie sytemu z częstotliwością \SI{1600}{\hertz} powinno być więc teoretycznie możliwe w wyniku lepszego zoptymalizowania oprogramowania \textit{CASKET}a.

Zwiększenie częstotliwości wysyłanych danych możliwe będzie 
gdy użyte zostanie \textit{Direct Memory Access} (DMA) na liniach komunikacyjnych.
