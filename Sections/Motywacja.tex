...
Stworzenie modelu układu wykonawczego wymaga zidentyfikowania modelu, który będzie w stanie odwzorować zachowanie rzeczywistego układu wykonawczego
...
Ponadto w \cite{olgierd} zidentyfikowano potrzebę wprowadzenia poprawek do zadanych wychyleń sterów w celu mitygacji błędów enkoderów poszczególnych serwomechanizmów.
...
Jednym z etapów testowania rakiet jest przeprowadzanie symulacji Hardware-in-the-Loop (HIL).
...
symulacji HIL jest stworzenie systemu umożliwiającego przeprowadzenie misji rakiety lotu do celu
...
tworząc tym samym kompletne stanowisko testów HIL rakiety FOK 2 (SHED) \cite{skromak2026hilall}.
